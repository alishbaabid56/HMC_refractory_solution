...
export default function Hero() {
  ...
  return (
    <section className="relative flex min-h-[360px] items-center overflow-hidden md:min-h-[430px] lg:min-h-[500px]">
      {/* Background Image */}
      <Image
        src="/images/hero.jpg"
      ...
      {/* Content */}
      <div className="relative z-10 mx-auto w-full max-w-7xl px-6 py-8 lg:px-8 lg:py-12">
        <motion.div
        ...
        >
          ...
          {/* Heading */}
          <h1 className="font-heading text-2xl font-bold leading-tight text-white sm:text-4xl lg:text-5xl">
          ...
          {/* Description */}
          <p className="mx-auto mt-3 max-w-xl text-sm leading-6 text-gray-200 sm:text-base">
            HMC Refractory Solution provides high-quality refractory products
            and industrial services for reliable performance in demanding
          ...
          <div className="mt-6 flex flex-col items-center justify-center gap-3 sm:flex-row">
            <Link
              href="#contact"
              className="inline-flex items-center gap-2 rounded-full bg-brand-yellow px-5 py-2.5 font-semibold text-black transition-all duration-300 hover:scale-105 hover:bg-yellow-500"
            >
              Get Consultation
            ...
            <a
              ...
              className="inline-flex items-center gap-2 rounded-full border border-white/40 bg-white/10 px-5 py-2.5 font-semibold text-white backdrop-blur-sm transition-all duration-300 hover:border-brand-yellow hover:text-brand-yellow"
            >
